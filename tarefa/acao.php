...
if (isset($_POST['create_usuario'])) {
    ...
    $sql = "INSERT INTO tarefas (tarefa, titulo, fazer, termino ,data) VALUES ('$tarefa', '$titulo', '$fazer', '$termino', '$data')";
...
if (isset($_POST['edita_usuario'])) {
    ...
    $sql = "UPDATE tarefas SET tarefa = '{$tarefa}', titulo = '{$titulo}', fazer = '{$fazer}', termino = '{$termino}',data = '{$data}' ";
    }
